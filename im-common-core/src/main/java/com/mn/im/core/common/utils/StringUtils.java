...
public class StringUtils {
    ...
    public static final String VERTICAL = "\\|"; // 符号“|”
     ...
     * @return
     */
    public static boolean notEquals(Object str1, Object str2) {
        if(str1 == null || str2 == null)
            return str1 == str2;
        return !equals(str1.toString(),str2.toString());
    }

    /**
     * @Title:
     * @Description: 判断一个值,是否在多个值中存在
     * @param val val1
     * @return
     * @throws
     * @author qiaomengnan
     * @date 2018/12/14 09:58:50
     */
    public static boolean in(String val, String... val1){
        if(val != null && val1 != null){
            for(String tmp : val1){
                if(StringUtils.equals(val,tmp))
                    return true;
            }
        }
        return false;
     ...
     * @date 2018/12/14 09:58:50
     */
    public static boolean notIn(String val, String...val1){
        return !in(val,val1);
    }
    ...
    public static List<String> splitToList(String delimiter, String value){
        ...
        if(ArrayUtils.isNotNullAndLengthNotZero(resultArray))
            results = new ArrayList<>(ArrayUtils.asList(resultArray));
        return results;
    }
    ...
    /**
     * @Title:
     * @Description:   为空则返回null
     * @param val
     * @return
     * @throws
     * @author qiaomengnan
     * @date 2018/11/27 04:14:03
     */
    public static String getValueEmptyNull(Object val){
        if(isTrimBlank(val))
            return null;
    ...
    */
    public static int compare(String val1, String val2) {
        if (isContainTrimBlank(val1, val2))
            throw new ServiceException("对比的值不能为空");
