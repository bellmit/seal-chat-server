...
import com.mn.im.core.common.extend.rpc.FileUploadRpc;
...
public class FileUploadRpcImpl implements FileUploadRpc {
    ...
    public ResponseEntity<RestResponse> fileUpload(String requestUrl, Object object ,
            String fileName, List<MultipartFile> multipartFiles){
        try{
    ...
    public ResponseEntity<RestResponse> fileUpload(
            String requestUrl, String fileName, List<MultipartFile> multipartFiles){
        try{
            HttpHeaders headers = getHeader(requestUrl);
            MultiValueMap<String, Object> formParams = new LinkedMultiValueMap<>();
     ...
     * @date 2018/02/06 11:00:08
     */
    public ResponseEntity<RestResponse> fileUpload(String requestUrl, String fileName,
            Map<String, Object> params, List<MultipartFile> multipartFiles){
        try{
            HttpHeaders headers = getHeader(requestUrl);
            MultiValueMap<String, Object> formParams = new LinkedMultiValueMap<>();
            for(MultipartFile multipartFile : multipartFiles){
    ...
    private HttpHeaders getHeader(String requestUrl){
        ...
        if(WebServiceNames.isLmsAgent(requestUrl)){
    ...
    private void setParamFileByteArrays(MultiValueMap<String, Object> formParams, String fileName,
